...
export class Container {
    ...
    /**
     * Controls Container {HTMLElement}
     */
    webRtcControlsContainer;

    /**
     * Bottom Controls Container {HTMLElement}
     */
    webRtcBottomControlsContainer
    ...
    addWebRtcControlsContainer() {
        ...
        this.webRtcControlsContainer.addEventListener('touchstart', (e) => {
    ...
    addWebRtcBottomControlsContainer() {
        ...
        appendChildElement(this.webRtcControlsContainer, this.webRtcBottomControlsContainer)
    }

    addWebRtcBottomControlsPanel() {
        this.webRtcControlsButtonPanel = createHTMLElement('div');
        this.webRtcControlsButtonPanel.classList.add('webrtc-controls-button-panel');
        appendChildElement(this.webRtcBottomControlsContainer, this.webRtcControlsButtonPanel)
    }
    ...
    addEventListeners() {
        ...
        this.webRtcContainer.addEventListener('touchmove', (e) => {
            this.onMouseMove(e);
        }, {passive: true})


        this.webRtcContainer.addEventListener('touchend', (e) => {
            this.onMouseMove(e);
        }, {passive: true})
        /**
         * Web Browser
